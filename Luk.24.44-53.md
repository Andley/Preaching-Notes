...
- (0) 前言：
	...
	- 上帝的啟示：一般啟示、特殊啟示
		- 特殊啟示：行動啟示(Deed Revelation)、話語啟示(Word Revelation)，兩者互相發明
		- 用神蹟奇事證明所傳的道！
	- 復活三部曲：
		- 24:1-12：復活(行動啟示)
		- 24:13-35：復活(行動啟示)＋聖經(話語啟示)
		- 24:36-49：復活(行動啟示)＋聖經(話語啟示) = 宣教(Missio Dei 上帝的差遣、上帝的使命)
		- 24:50-53：銜接使徒行傳 = 宣教的預備
- (1) 復活 (24:36-43)——Deed Revelation
