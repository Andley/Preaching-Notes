...
- (0) 開場
	- 聖道 (word) + 聖禮 (sacrament)：兩者同樣重要！
	- 聖道是用講的，是用腦袋去理解的；聖禮是用做的，是用親身去體會的 ⇒ 聖餐是個奧秘
- (1) 聖餐的意義 (vv.23-26)——神的心意
	...
	- (1c) 為了表明 (傳揚) 十字架 (v.26) ⇐ 現在
		- 聖餐 = 福音的行動劇場！
		- 聖餐 = 信望愛的具體呈現！
- (2) 該如何回應 (vv.27-32)——人的回應
	- (2a) 做法上，要**配得過**聖餐的意義 (v.27)
		- v不按理 (和合)、不按規矩 (和修)、不用敬虔的心 (現代中文)、不合適的態度 (新譯)、不合宜 (標準) ⇒ 干犯、得罪、冒犯主！
	- (2b) 心態上，要省察、要分辨 (vv.28-31)
		- 省察：自己 (v.28)；分辨：聖餐的意義 (v.29)
