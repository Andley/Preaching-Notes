...
- 1Co 6:4 
	- 6:4ab 條件句，ἐὰν + ἔχητε 假設語氣 = 第三類條件句，純粹是為了假設性的探討 for hypothetical consideration。反觀 1Co 6:2 的第一類條件句，卻多了份篤定：假設條件成立，然後接下來就該如何如何。
	...
	- 6:4b καθίζετε 的標點符號有三種可能解讀：
		...
		- a)、b) 比較可能。
- 1Co 6:5
	- 6:5ab 對等子句；6:5c 關係從屬子句，補充說明 6:5b 的主詞
